...
public class Solution {
    ...
    {
        java.nio.file.Files.copy(java.nio.file.Paths.get(resourceFileName), java.nio.file.Paths.get(destinationFileName), java.nio.file.StandardCopyOption.REPLACE_EXISTING);
    }
}
